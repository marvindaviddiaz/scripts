  ...
  DBMS_SCHEDULER.CREATE_JOB (
      ...
      job_action      => 'DECLARE
                          ...
                          BEGIN
                            ...
                            tablespace_ddl := ''create tablespace TBS_LOG_DTE'' || partition_name || '' datafile ''''TBS_LOG_DTE'' || partition_name ||''.dbf'''' size 100m autoextend on next 100m maxsize unlimited;'';
